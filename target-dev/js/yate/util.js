...
(function() {
    ...
    M.f7 = function f7(m, c0, i0, l0, a0, v19, v20) {
        var r0 = '';

        r0 += closeAttrs(a0);
        r0 += "<div class=\"" + "float-wrapper" + "\">";
        r0 += "<div class=\"" + "header" + "\">" + scalar2xml( ( v19 ) ) + "</div>";
        if ((v20)) {
            r0 += "<a href=\"" + "#" + "\" class=\"" + "button new" + "\">" + scalar2xml( ( v20 ) ) + "</a>";
        }
    ...
    M.f8 = function f8(m, c0, i0, l0, v21) {
        var r0 = '';
